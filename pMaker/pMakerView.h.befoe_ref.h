...
float    fInfluenceDirection; // y direction,
float    fCenterlineScale;
CString  fLeftSideFile;
CString  fRightSideFile;
...
protected:
	...
	//afx_msg void OnTreesTest2();
	afx_msg void OnTreesSaveextrusionandcenterline();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
public:
    afx_msg void OnTreesSavetreeparameters();
